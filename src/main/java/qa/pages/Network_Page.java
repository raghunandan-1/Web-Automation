...
public class Network_Page extends TestBase{
	...
	@FindBy(xpath="//a[normalize-space()='Network']")
    ...
    public String verifyPageTitle() {
    	String title=NetworkHeading.getText();
    ...
    public void verifycsvUploadButton() throws AWTException, IOException, InterruptedException 
	{
		...
		String sys = "Windows";
		String filepath = System.getProperty("user.dir") + "\\src\\main\\java\\qa\\testdata\\network.csv";
