...
public class Product_Page extends TestBase{
	...
	@FindBy(xpath = "/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/div[1]/div[2]/div[2]/div[1]/div[1]/div[1]/div[1]/section[1]/div[2]/div[1]/div[1]/button[1]")
    ...
    public String verifyPageTitle() {
    	String title=ProductHeading.getText();
    ...
    public void verifycsvUploadButton() throws AWTException, IOException, InterruptedException 
	{
		...
		String sys = "Windows";
		String filepath = System.getProperty("user.dir") + "\\src\\main\\java\\qa\\testdata\\product.csv";
