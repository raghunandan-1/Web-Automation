...
public class Mapping_Page extends TestBase{
	...
	@FindBy(xpath="//a[normalize-space()='Mapping']")
    ...
    public String verifyPageTitle() {
    	String title=MappingHeading.getText();
    ...
    public void verifycsvUploadButton() throws AWTException, IOException, InterruptedException 
	{
		...
		String sys = "Windows";
		String filepath = System.getProperty("user.dir") + "\\src\\main\\java\\qa\\testdata\\mapping.csv";
